...
class LoggerBASE:
    ...
    async def _save_log(self, guild_context: dict, message_context: dict, author_context: dict):
        """
...
class LoggerCSV(LoggerBASE):
    ...
    async def _save_log(self, guild_context: dict, message_context: dict, author_context: dict) -> None:
...
async def save_log(guild_context: dict, message_context: dict, author_context: dict):
    """
    ...
    while mgr is not None:
        try:
            await mgr._save_log(guild_context, message_context, author_context)
            break
        except Exception as exc:
