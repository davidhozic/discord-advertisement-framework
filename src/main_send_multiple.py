...
l_file1 = framework.FILE("LICENSE.md")
l_file2 = framework.FILE(".gitignore")
    ...
    framework.GUILD(
        ...
        messages_to_send=[                                  # List MESSAGE objects
            framework.MESSAGE(
                              ...
                              end_period=7,                # If start_period is None, it dictates the fixed sending period,
                                                            # If start period is defined, it dictates the maximum limit of randomized period
                              data=[          # Data you want to sent to the function (Can be of types : str, embed, file, list of types to the left
                              ...
                              channel_ids=[944959424068481094],      # List of ids of all the channels you want this message to be sent into
                              mode="edit",          # Clear all discord messages that originated from this MESSAGE object
