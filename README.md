...
# **Discord Shilling Framework (DSFW)**
**Table of contents:**
- [**Discord Shilling Framework (DSFW)**](#discord-shilling-framework-dsfw)
...
## **Introduction**
**NOTE:**<br>
**The Introduction section is just a surface explanation of what this is.** <br>
**To get the full information take a look at the lower sections which explain everything in a more detailed and a more explanatory way.**
***
...
Then define the server list and in that server list, define [**GUILD**](#framework_guild) and [**MESSAGE**](#framework_message) objects:
```py
guilds = [
    # GUILD 1
    framework.GUILD(
...
I recommend you take a look at the [**Examples**](Examples) folder.
<br>
...
- <a id="framework_message_data"></a> **Data** (data) - The data parameter is the actual data that will be sent using discord's API. The **data types** of this parameter can be: 
  ...
  - **Function** defined by the user:
    ...
    - ```py
      ...
      ```
    - **NOTE 1**: <br>
        When you use the framework.data_function decorator on the function, it returns a special class that is used by the framework to get data.<br>
...
To **enable** trace messages, set the **debug** option to True inside the **[framework.run](framework_framework_run)** function.
***
<br>
